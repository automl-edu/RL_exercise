...
\begin{questions}
	...
	\indent
	\begin{itemize}
		\item Implement the Deep Q-Network (DQN) in \emph{deep\_q\_learning.py}. Try to vary the DQN architecture (wider, deeper) and record your observations in the \emph{observations.txt} file.
